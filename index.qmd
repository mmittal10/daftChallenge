...
# Create a PGM object with high DPI for quality
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Add lemon node with yellow/green coloring (vertical layout)
pgm.add_node("lemon", "Lemons", 1, 1, aspect=2.5, scale=1.2, fontsize=10.5,
             plot_params={
...
# Add scurvy prevention node with blue coloring (vertical layout)
pgm.add_node("scurvy", "Scurvy\nPrevention", 1, 0, aspect=2.5, scale=1.2, fontsize=10.5,
             plot_params={
                 'facecolor': 'lightblue', 
                 'edgecolor': 'darkblue', 
                 'linewidth': 2,
...
# Add edge between lemon and scurvy prevention
pgm.add_edge("lemon", "scurvy")

# Render the DAG
pgm.render()
plt.title("1747 Understanding: Lemons \n - correct but incomplete", fontsize=12, pad=20)
plt.show()
```
...
#| echo: false
#| fig-cap: "DAG 2: The Misguided Belief - Acid Kills Bacteria"
...
# Add acid node with orange/red coloring (vertical layout)
pgm.add_node("acid", "Acid", 1, 2, aspect=2.5, scale=1.2, fontsize=10.5,
             plot_params={
...
# Add bacteria death node with gray coloring (vertical layout)
pgm.add_node("bacteria", "Bacteria\nDeath", 2, 1, aspect=2.5, scale=1.2, fontsize=10.5,
             plot_params={
                 'facecolor': 'lightgray', 
                 'edgecolor': 'black', 
                 'linewidth': 2,
...
# Add scurvy prevention node with blue coloring (vertical layout)
pgm.add_node("scurvy", "Scurvy\nPrevention", 3, 0, aspect=2.5, scale=1.2, fontsize=10.5,
             plot_params={
                 'facecolor': 'lightblue', 
                 'edgecolor': 'darkblue', 
                 'linewidth': 2,
...
# Render the DAG
pgm.render()
plt.title("DAG 2 (Misguided): Acid kills bacteria - wrong understanding", fontsize=12, pad=20)
plt.show()
```
...
# Add Vitamin C node with green coloring (vertical layout) - larger size
pgm.add_node("vitamin_c", "Vitamin C", 1, 2, aspect=2.5, scale=1.5, fontsize=10.5,
             plot_params={
...
pgm.add_node("collagen_synthesis", "Collagen Synthesis", 2, 1, aspect=2.5, scale=1.5, fontsize=10.5,
             plot_params={
                 'facecolor': 'lightgray', 
                 'edgecolor': 'black', 
                 'linewidth': 2,
...
# Add scurvy prevention node with blue coloring (vertical layout)
pgm.add_node("scurvy", "Scurvy", 3, 0, aspect=2.5, scale=1.5, fontsize=10.5,
             plot_params={
                 'facecolor': 'lightblue', 
                 'edgecolor': 'darkblue', 
                 'linewidth': 2,
...
# Render the DAG
pgm.render()
plt.title("1928 Vitamin C prevents scurvy - complete and correct", fontsize=12, pad=20)
plt.show()
```
